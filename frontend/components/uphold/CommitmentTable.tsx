...
const filters: Array<{ label: string; value: "ALL" | CommitmentStatus }> = [
  { label: "All", value: "ALL" }, { label: "Active", value: "ACTIVE" }, { label: "Breach claimed", value: "BREACH_CLAIMED" }, { label: "Contested", value: "CONTESTED" }, { label: "Confirmed", value: "BREACH_CONFIRMED" }, { label: "Completed", value: "COMPLETED" }, { label: "Settled", value: "SETTLED" },
];
...
export function CommitmentTable({ mineOnly = false, actor = null }: { mineOnly?: boolean; actor?: string | null }) {
  ...
  if (isError) return <div className="notice notice-error">The commitment index could not be read from Studio Next. No local or cached data is being shown.</div>;
